...
void graphMenu(Graph& graph) {
    ...
    while (true) {
        ...
        cout << "14. Найти кратчайший путь между двумя вершинами c помощью алгоритма Дейкстры \n";
        ...
        cout << "17. Найти максимальный поток с помощью алгоритма Форда-Флакерсона \n";
        cout << "18. Визуализировать граф \n";
        cout << "19. Выйти \n";
        cout << "Выберите опцию: ";
        while (!(cin >> option)) {
        ...
        case 14: 
            ...
            cout << "Введите конечную вершину: ";
            cin >> to;
            graph.findShortestPathDijkstra(from, to);
            break;
        case 15:
            cout << "Введите начальную вершину: ";
            cin >> from;
        ...
        case 17:
            ...
            cout << "Введите конечную вершину: ";
            cin >> to;
            cout<<graph.fordFulkerson(from, to);
